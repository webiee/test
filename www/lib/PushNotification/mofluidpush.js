...
**************************************************/
    ...
    */
    function tokenHandler(result) {
       ...
       $.getJSON(""+BASE_URL+"?callback=?"+"&store="+STORE+"&service=register_push&pushtoken="+result+"&platform="+PLATFORM+"&deviceid="+deviceid+"&appname="+APP_NAME+"&description=RegisterforPush",
          function (response) {
    ...
    function onNotificationGCM(e) {
               ...
               function showPush(message) {
                   ...
                   if(message == "" || message == null){
                       ...
                       var push_head_title = locale.message.text.push_notification;
                       if(push_head_title == "" || push_head_title == null)
                           var push_head_title = config.data[0].app_name + " Push Notification";
                       
                       navigator.notification.alert(message, function() {}, push_head_title, locale.message.button["close"]);
                   }
